...
?>
    ...
    <section>
	  <div class="container">
			<div class="table-responsive">
                ...
                <tbody>
				    ...
				    <?php } ?>
				        ...
				        <td class="existencia"><?php echo $order['inventa0'];?></td>
				        <td class="stock_max"><?php  echo $order['stockma0'];?></td>
	     ...
	     <?php   if($_GET["status"]=="pedido"){ ?>
        			<form action="../Controllers/relacion_controller.php" method="post">
