...
?>
								...
								<div class="table-responsive">
										...
										<tbody>
												...
												foreach ($productos as $producto) {
													...
													if($pedido0>=0){
														$costo_producto = $producto->ultcosto*$pedido0;
													}else{
														$costo_producto = 0;
													}
													...
													?>
														<tr>
															...
															<td class="stock_max"><?php echo $producto->stockma0;?></td>
															<td class="existencia"><?php echo $producto->inventa0;?></td>
		...
		<?php if($total_prod>0){
								...
								<form action="Controllers/producto_controller.php" method="post">
									...
									<input type="hidden" name="perfil" value="bodega">
									<center>
